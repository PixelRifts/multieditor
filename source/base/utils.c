...
string U_GetExtensionFromFilepath(string filepath) {
    u64 last_dot = str_find_last(filepath, str_lit("."), 0);
    return (string) { .str = filepath.str + last_dot, .size = filepath.size - last_dot };
}
